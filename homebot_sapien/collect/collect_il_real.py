...
def collect_imitation_data():
    ...
    # save_dir = os.path.join(PANDA_DATA, "single_obj","round11" ,"cola")  #  011_banana  cola
    save_dir = "tmp/expert/bowl"
    # save_dir = os.path.join(PANDA_DATA, "cano_policy_pd_5")  # 5000 traj for test
    name =round11  # change here
